        ...
        1: [function (_dereq_, module, exports) {
                ...
                function hlsjsExt(video, api, engineApi) {
                    ...
                    hls.on(Hls.Events.MANIFEST_PARSED, function (_, data) {
                        ...
                        video.qualities = video.qualities.concat(levels.map(function (level, i) {
                            ...
                            var label = "";
                            if (!qualityLabels[i] && hlsQualities !== 'drive') label += Math.round(level.bitrate / 1000) + 'p';
            ...
            flowplayer(function (api, root) {
                ...
                function createMenu(qualities) {
                    controlbar.appendChild(common.createElement('strong', { className: 'fp-qsel' }, 'ع©غŒظپغŒطھ'));
                    var menu = common.createElement('div', { className: 'fp-menu fp-qsel-menu' }, '<strong style="font-family:Vazir;">ع©غŒظپغŒطھ</strong>');
         ...
         <div class="fp-controls">\
            ...
            <strong class="fp-speed fp-hidden"></strong>\
                    ...
                    api.on("ready", function (ev, api, video) {
                        ...
                        // initial time & volume
                        common.html([durationEl, remaining], api.live ? 'ط²ظ†ط¯ظ‡' : format(duration));
            ...
            (function (root, factory) {
                ...
                var hasLastIndexBug = StringPrototype.lastIndexOf && 'abcمپ‚مپ„'.lastIndexOf('مپ‚مپ„', 2) !== -1;
                defineProperties(StringPrototype, {
