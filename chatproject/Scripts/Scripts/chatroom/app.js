...
WebRtcDemo.App = (function (viewModel, connectionManager) {
    var _hub,
        ...
        _connect = function (username, onSuccess, onFailure) {
            ...
            hub.client.setinitialMessage = function (message, connectionID, name, type, progressID, messageID, refresh) {
                if (name.indexOf("|") >= 0) {
                    name = name.split('|')[1]
                }
        ...
        _attachUiHandlers = function () {
            ...
            $(".submit").click(function () {  // به ازای هر آبجکت علاوه بر ذخیره سازی یه بلاب برای نمایش میسازد و مسیج را نیز میفرستد همراه با آرایه
                ...
                if (count != 0) {   // اگر تعداد فایل بالای صفر باشد دیگر کاری به نوشته دارد و فایل ها را میفرستد برای ارسال
                    ...
                    if (message != '') {
                        ...
                        li.innerHTML = `<div  id=` + progressID + `><span>` + uname + `  </span><br><p>` + message + `</p></div> `;
                        // var li = ' <li class="sent"> <img src = "http://emilcarlsson.se/assets/mikeross.png" alt = "" /> </li >';
                        ul.append(li);
            ...
            var timeNew;
            var intervalvarNew;
            $("#voicemessage").on('mousedown', function (e) {
                ...
                play("/beep.mp3").then(function () {
                    ...
                    //intervalvarNew = setInterval(function () {
                    //    f = document.getElementById('beepImage');
                    //    f.style.display = (f.style.display == 'none' ? 'flex' : 'none');
                    //}, 1000);
            ...
            $("#voicemessage").on('mouseup', function (e) {
                e.preventDefault();
                _stoprecordingNew();

                clearInterval(timeNew);
                //clearinterval(intervalvarNew);
            ...
            //$("#voicemessage").on('touchstart', function (e) {
            ...
            //    _startrecordingNew();
            //});
            //$("#voicemessage").on('touchend ', function (e) {
            //    e.preventDefault();
